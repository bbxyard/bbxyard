...
public class Db2Code {
    ...
    public static void main(String[] args) {
        String pkgName = "com.bbxyard.mp.comb";

        //1. 全局配置
        GlobalConfig config = new GlobalConfig();
        config.setActiveRecord(false) // 是否支持AR模式
                .setAuthor("bbxyard") // 作者
                .setOutputDir("/tmp/mp.gen.comb") // 生成路径
        ...
        stConfig.setCapitalMode(true) //全局大写命名
                ...
                .setTablePrefix("mp_comb_")
                .setEntityLombokModel(true) // 使用lombok
                .setRestControllerStyle(true)   // RestApi 风格
                .setInclude("mp_comb_student", "mp_comb_question");  // 生成的表
